    ...
    <main className="mx-auto max-w-7xl space-y-7 p-4 sm:p-8">
      ...
      >
        ...
        <div className="mt-4 flex flex-wrap items-end justify-between gap-6">
          <div>
            <h1 className="text-4xl font-bold">Reading Bank Static Audit</h1>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <Metric label="Skills" value={String(report.coverage.length)} />
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-4">
          {(
            ...
            <div key={label} className="rounded-2xl bg-slate-50 p-5">
              <p className="text-sm text-slate-500">Choice {label}</p>
              <p className="mt-2 text-3xl font-bold">{value}</p>
              <p className="mt-1 text-sm text-slate-500">
                {(
                  (value / Math.max(1, report.answerPositions.total)) *
                  100
                ).toFixed(1)}
                %
              </p>
      ...
      <section className="rounded-3xl border bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold">Skill and module capacity</h2>
      ...
      <section className="rounded-3xl border bg-white p-6 shadow-sm sm:p-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <h2 className="text-2xl font-bold">Audit issues</h2>
