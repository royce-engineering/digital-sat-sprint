    ...
    <main className="mx-auto max-w-6xl space-y-7 p-5 sm:p-8">
      ...
      >
        ...
        <h1 className="mt-3 text-4xl font-bold">
          First 18 Geometry Questions
        </h1>
        <p className="mt-3 text-white/75">
          {report.passed
            ? "The first Geometry expansion pack is ready."
      ...
      <section className="grid gap-4 sm:grid-cols-3 lg:grid-cols-6">
        ...
        <Metric
          ...
          value={
            report.duplicateChoiceQuestions
          }
        />
        <Metric
        ...
        <Metric
          label="Invalid SPR"
          value={
            report.invalidStudentResponses
          }
        />
        <Metric
          label="Status"
