    ...
    <main className="mx-auto max-w-7xl space-y-7 p-4 sm:p-8">
        ...
        <div className="mt-4 flex flex-wrap items-end justify-between gap-6">
          <div>
            <h1 className="text-4xl font-bold">
              Reading Coverage Audit
            </h1>
            <p className="mt-3 max-w-3xl text-slate-300">
              Domain × skill ×
              difficulty coverage,
              module eligibility, passage
              diversity, and recommended
              additions.
            </p>
          </div>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <Metric
          label="Passage types"
          value={String(
            report.uniquePassageTypes,
          )}
        />
        <Metric
          label="Critical / high cells"
          value={String(
            report.criticalCells
              .length,
          )}
        />
        <Metric
          ...
          value={String(
            report.recommendedNewQuestions,
          )}
        />
      </section>

      {(report.duplicateExamIds
        .length > 0 ||
        report.missingMetadataIds
          .length > 0) && (
        <section className="rounded-3xl border border-red-200 bg-red-50 p-6 text-red-950">
          ...
          {report.missingMetadataIds
            ...
            <p className="mt-3 text-sm">
              ...
              {report.missingMetadataIds.join(
                ", ",
              )}
            </p>
          )}
...
function priorityClass(
  priority: ReadingCoverageCell["priority"],
): string {
